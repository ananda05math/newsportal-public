                                    ...
                                    <div class="next-prev">
                                        ...
                                        <div class="blog-image">
                                            <a href="blog-single.html">
                                                ...
                                                <img src="images/education/3.jpg" alt="category photo">
                                            </a>
                                        </div>
                                        <div class="dsc">
                                        ...
                                        <div class="item">
                                            <div class="blog-image">
                                                <a href="blog-single.html">
                                                    <i class="fa fa-link" aria-hidden="true"></i>
                                                    <img src="images/education/6.jpg" alt="category photo">
                                                </a>
                                            </div>
                                            <div class="dsc">
                                                <h3><a href="blog-single.html">Hackers Can Steal Your Financial Info With<br/> Your Name and Email</a></h3>
                    ...
                    <div class="row">
                        <ul>
                            <li>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="next-prev">
                                        ...
                                        <div class="blog-image">
                                            <a href="blog-single.html">
                                            <i class="fa fa-link" aria-hidden="true"></i>
                                                <img src="images/education/1.jpg" alt="category photo">
                                            </a>
                                        </div>
                                        </div>
                                        <div class="item">
                                            <div class="blog-image">
                                                <a href="blog-single.html">
                                                    <i class="fa fa-link" aria-hidden="true"></i>
                                                    <img src="images/education/2.jpg" alt="category photo">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <h3><a href="blog-single.html">দিবালা-ইকার্দিকে বিশ্বকাপে না রাখার ইঙ্গিত আর্জেন্টিনা কোচের</a></h3>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="carousel-inner">
                                        <div class="blog-image">
                                            ...
                                            <a href="blog-single.html">
                                                <img src="images/education/4.jpg" alt="category photo">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <h3><a href="blog-single.html">মুক্তিযুদ্ধে অংশগ্রহণ জীবনের সবচেয়ে বড় অর্জন: অজয় রায়</a></h3>
                                    <span class="date"><i class="fa fa-calendar-check-o" aria-hidden="true"></i> Sep 13, 2017</span>               <span class="like"><a href="#"><i class="fa fa-comment-o" aria-hidden="true"></i>  12 </a></span>
                                    <p>দেশের মানুষকে নিরাপদ ও স্বাস্থ্যসম্মত খাদ্য সরবরাহ নিশ্চিতে এ বিষয়ে ব্যাপক গবেষণা প্রয়োজন বলে মন্তব্য করেছেন বিসেফ ফাউন্ডেশনের নির্বাহী পরিচালক এস এম মনোয়ার হোসেন।...</p>
                                </div>
                            </li>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="carousel-inner">
                                        <div class="blog-image">
                                            <a href="blog-single.html">
                                                <i class="fa fa-link" aria-hidden="true"></i>
                                                <img src="images/education/5.jpg" alt="category photo">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="carousel-inner">
                                            <div class="blog-image">
                                                <a href="blog-single.html">
                                                    <i class="fa fa-link" aria-hidden="true"></i>
                                                    <img src="images/education/7.jpg" alt="category photo">
                                                </a>
                                            </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="carousel-inner">
                                        <div class="blog-image">
                                            <a href="blog-single.html">
                                                <i class="fa fa-link" aria-hidden="true"></i>
                                                <img src="images/education/8.jpg" alt="category photo">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="carousel-inner">
                                        <div class="blog-image">
                                            <a href="blog-single.html">
                                                <i class="fa fa-link" aria-hidden="true"></i>
                                                <img src="images/education/9.jpg" alt="category photo">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="carousel-inner">
                                        <div class="blog-image">
                                            <a href="blog-single.html">
                                                <i class="fa fa-link" aria-hidden="true"></i>
                                                <img src="images/education/10.jpg" alt="category photo">
                                            </a>
                                        </div>
                                    </div>
                                </div>
