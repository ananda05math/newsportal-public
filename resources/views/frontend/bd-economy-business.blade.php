                                    ...
                                    <div class="next-prev">
                                        ...
                                        <div class="blog-image">
                                            <a href="blog-single.html">
                                                ...
                                                <img src="images/economy/3.jpg" alt="economy photo">
                                            </a>
                                        </div>
                                        <div class="dsc">
                                        ...
                                        <div class="item">
                                            <div class="blog-image">
                                                <a href="blog-single.html">
                                                    <i class="fa fa-link" aria-hidden="true"></i>
                                                    <img src="images/economy/6.jpg" alt="economy photo">
                                                </a>
                                            </div>
                                            <div class="dsc">
                                                <h3><a href="blog-single.html">Hackers Can Steal Your Financial Info With<br/> Your Name and Email</a></h3>
                    ...
                    <div class="row">
                        <ul>
                            <li>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="next-prev">
                                        ...
                                        <div class="blog-image">
                                            <a href="blog-single.html">
                                            <i class="fa fa-link" aria-hidden="true"></i>
                                                <img src="images/economy/1.jpg" alt="economy photo">
                                            </a>
                                        </div>
                                        </div>
                                        <div class="item">
                                            <div class="blog-image">
                                                <a href="blog-single.html">
                                                    <i class="fa fa-link" aria-hidden="true"></i>
                                                    <img src="images/economy/2.jpg" alt="economy photo">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <h3><a href="blog-single.html">এক সপ্তাহে ফেইসবুকের দর কমেছে ৫৮ বিলিয়ন ডলার</a></h3>
                                    <span class="date"><i class="fa fa-calendar-check-o" aria-hidden="true"></i> Sep 13, 2017</span>
                                    <span class="like"><a href="#"><i class="fa fa-comment-o" aria-hidden="true"></i>  12 </a></span>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="carousel-inner">
                                        <div class="blog-image">
                                            ...
                                            <a href="blog-single.html">
                                                <img src="images/economy/4.jpg" alt="economy photo">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="carousel-inner">
                                        <div class="blog-image">
                                            <a href="blog-single.html">
                                                <i class="fa fa-link" aria-hidden="true"></i>
                                                <img src="images/economy/5.jpg" alt="economy photo">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="carousel-inner">
                                        <div class="blog-image">
                                            <a href="blog-single.html">
											<i class="fa fa-link" aria-hidden="true"></i>
                                                <img src="images/economy/7.jpg" alt="economy photo">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="carousel-inner">
                                        <div class="blog-image">
                                            <a href="blog-single.html">
                                                <i class="fa fa-link" aria-hidden="true"></i>
                                                <img src="images/economy/8.jpg" alt="economy photo">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="carousel-inner">
                                        <div class="blog-image">
                                            <a href="blog-single.html">
                                                <i class="fa fa-link" aria-hidden="true"></i>
                                                <img src="images/economy/9.jpg" alt="economy photo">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="carousel-inner">
                                        <div class="blog-image">
                                            <a href="blog-single.html">
                                                <i class="fa fa-link" aria-hidden="true"></i>
                                                <img src="images/economy/10.jpg" alt="economy photo">
                                            </a>
                                        </div>
                                    </div>
                                </div>
