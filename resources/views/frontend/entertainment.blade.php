                                    ...
                                    <div class="next-prev">
                                        ...
                                        <div class="blog-image">
                                            <a href="blog-single.html">
                                                ...
                                                <img src="images/entertainment/1.jpg" alt="category photo">
                                            </a>
                                        </div>
                                        <div class="dsc">
                                        ...
                                        <div class="item">
                                            <div class="blog-image">
                                                <a href="blog-single.html">
                                                    <i class="fa fa-link" aria-hidden="true"></i>
                                                    <img src="images/entertainment/2.jpg" alt="category photo">
                                                </a>
                                            </div>
                                            <div class="dsc">
                                                <h3><a href="blog-single.html">Hackers Can Steal Your Financial Info With<br/> Your Name and Email</a></h3>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="next-prev">
                                        ...
                                        <div class="blog-image">
                                            <a href="blog-single.html">
                                            <i class="fa fa-link" aria-hidden="true"></i>
                                                <img src="images/entertainment/3.jpg" alt="category photo">
                                            </a>
                                        </div>
                                        </div>
                                        <div class="item">
                                            <div class="blog-image">
                                                <a href="blog-single.html">
                                                    <i class="fa fa-link" aria-hidden="true"></i>
                                                    <img src="images/entertainment/4.jpg" alt="category photo">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                   <div class="carousel-inner">
                                        <div class="blog-image">
                                            ...
                                            <a href="blog-single.html">
                                                <img src="images/entertainment/5.jpg" alt="category photo">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="carousel-inner">
                                        <div class="blog-image">
                                            <a href="blog-single.html">
                                                <i class="fa fa-link" aria-hidden="true"></i>
                                                <img src="images/entertainment/6.jpg" alt="category photo">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="carousel-inner">
                                        <div class="blog-image">
                                            ...
                                            <a href="blog-single.html">
											 <i class="fa fa-link" aria-hidden="true"></i>
                                                <img src="images/entertainment/7.jpg" alt="category photo">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="carousel-inner">
                                        <div class="blog-image">
                                            <a href="blog-single.html">
                                                <i class="fa fa-link" aria-hidden="true"></i>
                                                <img src="images/entertainment/8.jpg" alt="category photo">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="carousel-inner">
                                        <div class="blog-image">
                                            <a href="blog-single.html">
                                                <i class="fa fa-link" aria-hidden="true"></i>
                                                <img src="images/entertainment/9.jpg" alt="category photo">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="carousel-inner">
                                        <div class="blog-image">
                                            <a href="blog-single.html">
                                                <i class="fa fa-link" aria-hidden="true"></i>
                                                <img src="images/entertainment/10.jpg" alt="category photo">
                                            </a>
                                        </div>
                                    </div>
                                </div>
