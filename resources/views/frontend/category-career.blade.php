                                    ...
                                    <div class="next-prev">
                                        ...
                                        <div class="blog-image">
                                            <a href="blog-single.html">
                                                ...
                                                <img src="images/career/3.jpg" alt="category photo">
                                            </a>
                                        </div>
                                        <div class="dsc">
                                        ...
                                        <div class="item">
                                            <div class="blog-image">
                                                <a href="blog-single.html">
                                                    <i class="fa fa-link" aria-hidden="true"></i>
                                                    <img src="images/career/6.jpg" alt="category photo">
                                                </a>
                                            </div>
                                            <div class="dsc">
                                                <h3><a href="blog-single.html">Hackers Can Steal Your Financial Info With<br/> Your Name and Email</a></h3>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="next-prev">
                                        ...
                                        <div class="blog-image">
                                            <a href="blog-single.html">
                                            <i class="fa fa-link" aria-hidden="true"></i>
                                                <img src="images/career/1.jpg" alt="category photo">
                                            </a>
                                        </div>
                                        </div>
                                        <div class="item">
                                            <div class="blog-image">
                                                <a href="blog-single.html">
                                                    <i class="fa fa-link" aria-hidden="true"></i>
                                                    <img src="images/career/2.jpg" alt="category photo">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="carousel-inner">
                                        <div class="blog-image">
                                            ...
                                            <a href="blog-single.html">
                                                <img src="images/career/4.jpg" alt="category photo">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="carousel-inner">
                                        <div class="blog-image">
                                            <a href="blog-single.html">
                                                <i class="fa fa-link" aria-hidden="true"></i>
                                                <img src="images/career/5.jpg" alt="category photo">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="carousel-inner">
                                            <div class="blog-image">
                                                <a href="blog-single.html">
                                                    <i class="fa fa-link" aria-hidden="true"></i>
                                                    <img src="images/career/7.jpg" alt="category photo">
                                                </a>
                                            </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="carousel-inner">
                                        <div class="blog-image">
                                            <a href="blog-single.html">
                                                <i class="fa fa-link" aria-hidden="true"></i>
                                                <img src="images/career/8.jpg" alt="category photo">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="carousel-inner">
                                        <div class="blog-image">
                                            <a href="blog-single.html">
                                                <i class="fa fa-link" aria-hidden="true"></i>
                                                <img src="images/career/9.jpg" alt="category photo">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="carousel-inner">
                                        <div class="blog-image">
                                            <a href="blog-single.html">
                                                <i class="fa fa-link" aria-hidden="true"></i>
                                                <img src="images/career/10.jpg" alt="category photo">
                                            </a>
                                        </div>
                                    </div>
                                </div>
